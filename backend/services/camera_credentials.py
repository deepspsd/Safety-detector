...
def _fernet() -> Fernet:
    ...
    if not secret:
        raise CredentialConfigurationError("CAMERA_CREDENTIAL_KEY is required before registering IP cameras")
...
def decrypt(value: str) -> str:
    try:
        ...
        raise CredentialConfigurationError("Stored camera credential cannot be decrypted with CAMERA_CREDENTIAL_KEY") from exc

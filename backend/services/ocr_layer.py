...
class OcrAdapter:
    def scan(self, camera_id: int, frame, bbox, *, direction: str = "inward", track_id: str | None = None, zone_id: int | None = None):
        ...
        emit("OCR_SUCCESS" if passed else "OCR_FAILED", camera_id=camera_id, zone_id=zone_id,
             track_id=track_id, source="ocr-layer", payload={"result": result or {}})
        return result

...
def inspect_camera(endpoint: str, username: str, password: str) -> dict:
    ...
    try:
        ...
        raise OnvifUnavailable("ONVIF support is not installed; install onvif-zeep in backend/.venv") from exc
    ...
    try:
        ...
        raise OnvifConnectionError("ONVIF authentication or capability discovery failed") from exc
